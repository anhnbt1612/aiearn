...
public class AbstractWebTest {
    ...
    public void setUpBrowser(@Optional("chrome") String browser, @Optional("aiearn") String env) throws JSchException {
        System.setProperty("aiearn.browser", browser);
        new Url(env);
    }

    @BeforeMethod
    public void initializeDriver() {
        WebAppDriverManager.initializeDriver();
    }
